...
* `nginx -V` - версия Nginx и его скомпилированные параметры конфигурации. 
* `nginx -t` - посмотреть установленные модули и все конфигурации на сервере, а также определить их расположение. 
